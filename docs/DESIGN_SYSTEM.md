...
- A breakpoint needs **margin, not a fit**. Text width is font metrics, and a CI runner does not have a Mac's fonts: the same row measured 646px of min-content locally and 693px on `ubuntu-latest`.
